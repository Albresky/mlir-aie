...
module @host_multirate {
    ...
    %objFifo_in = AIE.objectFifo.createObjectFifo(%tile70, {%tile34}, 1:i32) {sym_name = "of_in"}  : !AIE.objectFifo<memref<64xi32>>
    %objFifo_out = AIE.objectFifo.createObjectFifo(%tile34, {%tile70}, 1:i32) {sym_name = "of_out"}  : !AIE.objectFifo<memref<64xi32>>
